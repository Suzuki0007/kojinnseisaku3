...
int EffekseerManager::PlayEffect3DPos(int handle, const Vec4& pos)
{
	if(handle == -1)
	{
		return -1;
...
bool EffekseerManager::SetRotationEffect(int handle, const Vec4& rad)
{
	if(handle == -1)
	{
		return false;
...
Vec4 EffekseerManager::GetRotationEffect(int handle) const
{
...
bool EffekseerManager::SetPosEffect(int handle, const Vec4& pos)
{
	if(handle == -1)
	{
		return false;
...
Vec4 EffekseerManager::GetPosEffect(int handle) const
{
	if(!_initialize || handle == -1)
	{
		return Vec4(0.0f, 0.0f, 0.0f);
...
bool EffekseerManager::SetRotationEffectDeg(int handle, const Vec4& deg)
{
	if(handle == -1)
	{
		return false;
	}
	Vec4 rad = Vec4(DEG2RAD(deg.x), DEG2RAD(deg.y), DEG2RAD(deg.z));
	return SetRotationEffect(handle, rad);
}

Vec4 EffekseerManager::GetRotationEffectDeg(int handle) const
{
	Vec4 rad = GetRotationEffect(handle);
	return Vec4(RAD2DEG(rad.x), RAD2DEG(rad.y), RAD2DEG(rad.z));
}
...
// 	// 2Dエフェクト再生(位置指定)
int EffekseerManager::PlayEffect2DPos(int handle, const Vec4& pos)
{
	if(handle == -1)
	{
		return -1;
...
Vec4 EffekseerManager::GetPosEffect2D(int handle) const
{
	if(!_initialize || handle == -1)
	{
		return Vec4(0.0f, 0.0f, 0.0f);
...
// 	// 2Dエフェクト位置設定
bool EffekseerManager::SetPosEffect2D(int handle, const Vec4& pos)
{
	if(handle == -1)
	{
		return false;
...
// 	// 2Dエフェクト回転設定
bool EffekseerManager::SetRotationEffect2D(int handle, const Vec4& rad)
{
	if(handle == -1)
	{
		return false;
...
Vec4 EffekseerManager::GetRotationEffect2D(int handle) const
{
	if(!_initialize || handle == -1)
	{
		return Vec4(0.0f, 0.0f, 0.0f);
...
Vec4 EffekseerManager::GetScaleEffect2D(int handle) const
{
	if(!_initialize || handle == -1)
	{
